...
?>
      <li>
        ...
        <a href="<?php echo get_permalink() ?>" title="<?php the_title(); ?>"><img class="border hover" src="<?php echo get_template_directory_uri(); ?>/thumb.php?src=<?php echo $image[0]; ?>&h=125&w=270&q=100" height="125" width="270" /></a><br />
