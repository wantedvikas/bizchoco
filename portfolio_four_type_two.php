<?php
/*
Template Name: Portfolio 4 Column Type 2
*/
...
?>
            <li>
                ...
                <a href="<?php echo get_permalink() ?>" title="<?php the_title(); ?>"><img class="border hover" src="<?php echo get_template_directory_uri(); ?>/thumb.php?src=<?php echo $image[0]; ?>&h=250&w=205&q=100" height="250" width="205" /></a><br /><br />
